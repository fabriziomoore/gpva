...
export function DisclaimerBanner() {
  return (
    <div className="w-full px-3 pt-[calc(0.5rem+env(safe-area-inset-top))]">
      <p
        role="note"
        className="mx-auto w-full max-w-2xl rounded-xl border border-destructive/40 bg-destructive/25 px-4 py-2.5 text-center text-[11px] leading-relaxed text-foreground shadow-lg backdrop-blur-md sm:text-xs"
      >
