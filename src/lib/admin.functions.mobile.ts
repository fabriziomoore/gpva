...
export type SetorRow = { id: string; nome: string; variavel_ativo: boolean; negociacao_ativa: boolean };
...
export type SupervisorRow = {
  id: string; nome: string; setor_ids: string[]; setor_nomes: string[]; user_id: string | null;
};
