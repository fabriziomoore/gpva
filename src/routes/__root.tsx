...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ASSIS GESP" },
      { name: "description", content: "ASSIS GESP — Assistência em Campo e Gestão da Produtividade." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "ASSIS GESP" },
      { property: "og:description", content: "ASSIS GESP — Assistência em Campo e Gestão da Produtividade." },
      ...
      { name: "apple-mobile-web-app-title", content: "ASSIS GESP" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "twitter:title", content: "ASSIS GESP" },
      { name: "twitter:description", content: "ASSIS GESP — Assistência em Campo e Gestão da Produtividade." },
