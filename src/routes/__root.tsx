  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold text-canvas-foreground">404</h1>
        <h2 className="mt-4 text-xl font-semibold text-canvas-foreground">Page not found</h2>
        <p className="mt-2 text-sm text-canvas-foreground/70">
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-canvas-foreground">
