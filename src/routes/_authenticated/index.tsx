...
function HomePage() {
  ...
  if (isLoading) {
    return (
      <AppShell title={<span className="flex w-full items-baseline gap-1 whitespace-nowrap"><span>GPVA</span> <span className="text-[14px] font-medium text-muted-foreground">- GESTÃO DE PRODUTIVIDADE E VARIÁVEL AUTÔNOMA</span></span>}>
